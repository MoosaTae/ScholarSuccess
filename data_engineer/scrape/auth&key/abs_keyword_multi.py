...
def main():
    BASE_DATASET_PATH = '/Users/jp/Desktop/ScholarSuccess/data_engineer/scrape/auth&key/ScrapeDataset'  # change path
    OUTPUT_PATH = '/Users/jp/Desktop/ScholarSuccess/data_engineer/scrape/auth&key/abs_ref_data'  # change path
    HEADERS = {
